...
import { getBatchwisePipelinedCompanies } from "../services/postRequest";
...
const ShowPipelinedCompanies = () => {
  ...
  const onHandleSubmit = (event) => {
    ...
    setSpinner(true);
    getBatchwisePipelinedCompanies(neededBatch)
      .then((res) => {
        if (res.data.Success) {
    ...
    <>
      ...
      <Container style={{ marginTop: "4%" }}>
        ...
        <Row style={{ marginTop: "3%" }}>
          <Card>
            <h5 style={{ marginLeft: "3%" }}>Pipelined Companies</h5>
            <hr
...
export default ShowPipelinedCompanies;
